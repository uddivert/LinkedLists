...
public class SortedLinkedList {
    ...
    /**
     * inserts ItemType item into linkedList
     */
    ...
    /**
     * deletes ItemType item into linkedList
     */
    ...
    /**
     * searches for ItemType item in linkedList
     */
    ...
    /**
     * Complexity: This is O(n) = n
     * merges two different lists together
     */
    public void mergeList() {
        //Scan what is entered, put it into new array, combine it with csvArray, and re-initialize
        ...
        System.out.println("The list 1: " + toString());//prints original array
        String[] numbers = stringInput.split(" ");//stores new values into a string array
        int[] newLineArray = new int[listLength];
        
        for (int i = 0; i < listLength; i++) {
            newLineArray[i] = Integer.parseInt(numbers[i]);//re-stores the new values into an int array
        }//for
        
        String newListPrint = "The list 2: ";
        Arrays.sort(newLineArray);//sorts the new array
        
        for (int i = 0; i < listLength; i++) {
            newListPrint = newListPrint + newLineArray[i] + " ";
        }
        
        System.out.println(newListPrint);//prints the new array
        ...
        csvArray = removeDuplicates(mergedArray, mergedArray.length);//intended to remove extra instances of a variable
        initialize(csvArray);
    ...
    /**
     * This is O(n) = n
     * deletes alternate elements of the linked list
     */
    ...
    /**
     * Has a O(n)= n^2
     * returns the duplicated values between two lists
     */
